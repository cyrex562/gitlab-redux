// Ported from: orig_app/app/controllers/projects/harbor/repositories_controller.rb
// Ported on: 2025-05-19
// This file implements the Projects::Harbor::RepositoriesController from the Ruby codebase.

use crate::controllers::projects::harbor::application_controller::ProjectsHarborApplicationController;

pub struct ProjectsHarborRepositoriesController {
    base: ProjectsHarborApplicationController,
}

impl ProjectsHarborRepositoriesController {
